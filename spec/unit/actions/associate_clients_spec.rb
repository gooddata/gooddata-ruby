...
describe GoodData::LCM2::AssociateClients do
  ...
  before do
    ...
    GoodData::LCM2::BaseAction.check_params(subject.class.const_get('PARAMS'), params)
  end
  ...
  context 'when delete_extra and delete_projects parameters are passed' do
    ...
    it 'logs warning and does nothing' do
      ...
      expect(mocked_logger).to receive(:warn)
      subject.class.call(params)
    end
  end
  ...
  context 'when delete_mode is not in list of possible modes' do
    ...
    it 'fails' do
      expect { subject.class.call(params) }.to raise_error(/The parameter/)
    end
  end
end
