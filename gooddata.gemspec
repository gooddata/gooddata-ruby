...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'rubocop', "~> 0.20", '>= 0.20'
  ...
  s.add_dependency 'bundler', "~> 1.6", '>= 1.6.1'
  s.add_dependency 'docile', '~> 1.1', '>= 1.1.3'
  s.add_dependency 'erubis', "~> 2.7", '>= 2.7.0'
  s.add_dependency 'gli', "~> 2.10", '>= 2.10.0'
  ...
  s.add_dependency 'parseconfig', "~> 1.0.4", '>= 1.0.4'
  s.add_dependency 'pmap', '~> 1.0', '>= 1.0.1'
  s.add_dependency 'pry', '~> 0.9', '>= 0.9.12.6'
  s.add_dependency 'restforce', "~> 1.4", '>= 1.4.3'
