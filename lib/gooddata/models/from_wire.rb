  ...
  module Model
    module FromWire
      class << self
        ...
        # @param stuff [Hash] Whatever comes from wire
        # @return [Hash] Manifest for a particular reference
        def parse_date_dimensions(stuff)
          Hash.new.tap do |d|
        ...
        # @return [Hash] Manifest for a particular reference
        def parse_label(attribute, label, type, default_label = nil)
          Hash.new.tap do |l|
            l[:type] = type
