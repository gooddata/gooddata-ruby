...
module GoodData
  class Dashboard < GoodData::MdObject
    ...
    def export(format, options = {})
      ...
      x = client.post(req_uri, 'clientExport' => { 'url' => "#{GoodData.project.client.connection.server.url}/dashboard.html#project=#{GoodData.project.uri}&dashboard=#{uri}&tab=#{tab}&export=1", 'name' => title })
