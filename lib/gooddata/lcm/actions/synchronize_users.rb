    ...
    class SynchronizeUsers < BaseAction
      ...
      class << self
        ...
        def call(params)
          ...
          common_params = [domain, whitelists, ignore_failures, remove_users_from_project, do_not_touch_users_that_are_not_mentioned, create_non_existing_user_groups]
          results = case mode
                    ...
                    when 'sync_multiple_projects_based_on_custom_id'
                      ...
                      new_users.group_by { |u| u[:pid] }.map do |client_id, nusers|
                        ...
                        puts "Project #{project.pid} of client #{client_id} will receive #{nusers.count} users"
                        project.import_users(nusers, common_params)
                      end.flatten
